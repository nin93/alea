...
module Alea
  struct Random(G)
    ...
    private def __uint64(max : Number) : UInt64
      if max.class < Float
        Alea::Utils.sanity_check(max, :max, :uint)
      end

      Alea::Utils.param_check(max, :<=, 0, :max, :uint)
    ...
    private def __uint64(min : Number, max : Number) : UInt64
      if min.class < Float
        Alea::Utils.sanity_check(min, :min, :uint)
      end
      ...
      Alea::Utils.param_check(min, :>=, max, :min, :uint)
      Alea::Utils.param_check(min, :<, 0, :min, :uint)
    ...
    private def __uint64(range : Range(Number, Number)) : UInt64
      ...
      if min.class < Float
        Alea::Utils.sanity_check(min, :"range.begin", :uint)
      end

      if max.class < Float
        Alea::Utils.sanity_check(max, :"range.end", :uint)
      end
    ...
    private def __uint32(max : Number) : UInt32
      if max.class < Float
        Alea::Utils.sanity_check(max, :max, :uint32)
      end

      Alea::Utils.param_check(max, :<=, 0, :max, :uint32)
    ...
    private def __uint32(min : Number, max : Number) : UInt32
      if min.class < Float
        Alea::Utils.sanity_check(min, :min, :uint32)
      end
      ...
      Alea::Utils.param_check(min, :>=, max, :min, :uint32)
      Alea::Utils.param_check(min, :<, 0, :min, :uint32)
    ...
    private def __uint32(range : Range(Number, Number)) : UInt32
      ...
      if min.class < Float
        Alea::Utils.sanity_check(min, :"range.begin", :uint32)
      end

      if max.class < Float
        Alea::Utils.sanity_check(max, :"range.end", :uint32)
      end
